...
public class MyDES {
    ...
    public static String decrypPassword(String passwd, String salt) {
        String password = MyDES.decryptBasedDes(passwd);
        if (password.contains(salt)) {
            password = password.substring(0, password.indexOf(salt));
        }
        return password;
    }
