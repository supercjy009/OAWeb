    ...
    */
    tableSelect.prototype.render = function (opt) {
        ...
        elem.on('click', function(e) {
            ...
            var tableBox = '<div class="tableSelect layui-anim layui-anim-upbit" style="left:'+l+';top:'+t+';border: 1px solid #d2d2d2;background-color: #fff;box-shadow: 0 2px 4px rgba(0,0,0,.12);padding:10px 10px 0 10px;position: absolute;z-index: 10000;margin: 5px 0;border-radius: 2px;">';
